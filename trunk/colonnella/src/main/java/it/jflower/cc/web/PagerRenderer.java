...
public class PagerRenderer extends Renderer {
	...
	public void encodeBegin(FacesContext context, UIComponent component)
		...
		ListDataModel<String> dataM = (ListDataModel<String>) data.getValue();
		List<String> lista = (List<String>) dataM.getWrappedData();
		int first = 1;
		int itemcount = dataM.getRowCount();
		int pagesize = 10;
		List<String> sub = lista.subList(1, 10);
		dataM.setWrappedData(sub);
		data.setValue(dataM);
