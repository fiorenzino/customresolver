...
public class ImageUtils {
	...
	public static Integer getImageWidthProportional(String url,
			Integer maxWidth, Integer maxHeight) {
		if (url == null)
			return 0;
	...
	public static Integer getImageHeightProportional(String url,
			Integer maxWidth, Integer maxHeight) {
		if (url == null)
			return 0;
		return getImageSizeProportional(getRealPath() + url, maxWidth,
				...
				if (height >= 0 && width >= 0)
					...
					if (waitTime < 0)
						...
						if (observer.isImageAborted()) {
							log
									.info("Image was aborted before production was complete.");
						}
					}
