...
public class TipoInformazioniHandler implements Serializable {
	...
	public static String VIEW = "/private/tipi-informazione/scheda-tipo-informazione.xhtml"+FACES_REDIRECT;
	public static String LIST = "/private/tipi-informazione/lista-tipi-informazione.xhtml"+FACES_REDIRECT;
	public static String NEW_OR_EDIT = "/private/tipi-informazione/gestione-tipo-informazione.xhtml"+FACES_REDIRECT;
...
//		setModel(new LocalDataModel<TipoInformazione>(pageSize, ricerca, getSession()));
