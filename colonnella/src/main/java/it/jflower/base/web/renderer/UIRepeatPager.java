...
public class UIRepeatPager extends Renderer {
	...
	public void encodeBegin(FacesContext context, UIComponent component) 
	      ...
	      String uiRepeatId = (String) component.getAttributes().get("uiRepeatId");
	      int showpages = toInt(component.getAttributes().get("showpages"));      
	      LocalDataModel model = (LocalDataModel) component.getAttributes().get("model");
	   ...
	   private String onclickCode(String formId, String id, String value) {
	      return new StringBuilder().append("document.forms['").append(formId).append("']['")
